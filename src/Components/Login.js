        ...
        <div className='main-page' >
            ...
            <NetflixSign>
                ...
                <form autoComplete='off'>
                    <div style={{position: 'relative', marginBottom: '20px'}} className='netflix-sign-inputs' >
                    ...
                    <NetflixButton className='netflix-button-login' styles={{padding: '12px 25px'}} >Sign {newUser ? 'Up' : 'In'}</NetflixButton>
                </form>
